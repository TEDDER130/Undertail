...
public class Containment extends Patroon {
    ...
    public void generateEntities() {
        ...
        if (axis == 0) {
            ...
            laserData[1] = playArea[1] - sizePlayer[1] / 2 + 30;
            laserData[2] = 1;
        } else if (axis == 1) {
            laserData[0] = playArea[0] - sizePlayer[0] / 2 + 30;
            laserData[1] = playArea[1] - sizePlayer[1] / 2;
            laserData[2] = 0;
        } else if (axis == 2) {
            laserData[0] = playArea[0] - sizePlayer[0] / 2;
            laserData[1] = playArea[1] - sizePlayer[1] / 2 + playArea[2] + sizePlayer[1] / 2 - 30;
            laserData[2] = 1;
        } else if (axis == 3) {
            laserData[0] = playArea[0] - sizePlayer[0] / 2 + playArea[3] + sizePlayer[0] / 2 - 30;
            laserData[1] = playArea[1] - sizePlayer[1] / 2;
            laserData[2] = 0;
        }
